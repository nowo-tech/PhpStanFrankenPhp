...
final class CoverageCompletenessTest extends TestCase
{
    ...
    public static function rulesProvider(): iterable
    {
        ...
        yield 'chdir' => [new NoChdirRule()];
        yield 'setlocale' => [new NoSetLocaleRule()];
        yield 'localeSetDefault' => [new NoLocaleSetDefaultRule()];
        yield 'timezone' => [new NoDateDefaultTimezoneSetRule()];
